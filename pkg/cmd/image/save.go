...
func Save(ctx context.Context, client *containerd.Client, images []string, options types.ImageSaveOptions, exportOpts ...archive.ExportOpt) error {
	return saveWithTransfer(ctx, client, images, options)
}

func saveWithTransfer(ctx context.Context, client *containerd.Client, images []string, options types.ImageSaveOptions) error {
