...
import (
	...
	"github.com/containerd/nerdctl/v2/pkg/streamutil/bytespipe"
	"github.com/containerd/nerdctl/v2/pkg/streamutil/pools"
)
...
func (c *StreamConfig) StdoutPipe() io.ReadCloser {
...
func (c *StreamConfig) StderrPipe() io.ReadCloser {
	bytesPipe := bytespipe.New()
...
func (c *StreamConfig) NewInputPipes() {
	c.stdin, c.stdinPipe = io.Pipe()
}

// NewNopInputPipe creates a new input pipe that will silently drop all messages in the input.
func (c *StreamConfig) NewNopInputPipe() {
...
func (c *StreamConfig) CloseStreams() error {
	var errs error
...
func (c *StreamConfig) CopyToPipe(iop *cio.DirectIO) {
	ctx := context.TODO()
...
func (c *StreamConfig) Wait(ctx context.Context) {
